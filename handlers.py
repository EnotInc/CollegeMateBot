...
async def cdm_help(message: Message):
    await message.answer("Расписание обновляется по втореикам, так что не удивляйся что в пн у тебя расписание за прошлую неделю. Я тут, кстати, вообще не виноват. Можешь винить дурацкий сайт колледжа и разраба неумеху, которому в падлу прописпть логику для вывода расписания на эту неделю.\nНо, по правде говоря, там хрен поймещ за какой день и кому расписание адресовано, так что сильно не бузи")
